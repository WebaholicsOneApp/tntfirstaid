    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto max-w-3xl px-4 py-12 md:py-16">
        ...
        {data.orders.length === 0 ? (
          <div className="border-secondary-100 rounded-2xl border bg-white p-8 text-center shadow-[0_4px_24px_rgba(0,0,0,0.06)] md:p-12">
            ...
            <h2 className="font-display text-secondary-900 mb-2 text-lg font-bold">
              No orders yet
            </h2>
