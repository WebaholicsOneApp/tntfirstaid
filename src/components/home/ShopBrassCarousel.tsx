      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <AnimateIn animation="fade-up" delay={100}>
          ...
          >
            {hasDbProducts ? (
              items.map((product) => (
                <div key={(product as ProductListItem).id} className="flex-shrink-0 w-[200px] sm:w-[230px] snap-start">
              ...
              (items as typeof placeholderBrass).map((item) => (
                <Link
                  ...
                  className="flex-shrink-0 w-[200px] sm:w-[230px] snap-start group block bg-white border border-secondary-100 hover:border-primary-300 hover:shadow-md transition-all duration-200"
                >
