  ...
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
      ...
      <div className="space-y-6">
        ...
        selectedVariation?.downloadUrl ? (
          <a
            href={selectedVariation.downloadUrl}
            download
            className="bg-primary-500 text-secondary-900 hover:bg-primary-400 active:bg-primary-600 flex items-center justify-center gap-2 rounded-md px-6 py-3 text-sm font-semibold tracking-wider uppercase transition-all"
          >
            <svg
              className="h-4 w-4"
              fill="none"
