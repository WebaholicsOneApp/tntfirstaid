...
export function openPrecisionPayPortal(
  options: OpenPortalOptions,
): Promise<PrecisionPayResult> {
  return new Promise((resolve) => {
    ...
    overlay.style.cssText =
      "position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:99999;background:rgba(255,255,255,0.5);transition:0.3s;";

    const iframe = document.createElement("iframe");
    iframe.src = iframeUrl;
    iframe.title = "PrecisionPay Checkout";
    iframe.style.cssText =
      "position:fixed;top:0;left:0;border:0;width:100vw;height:100vh;";
